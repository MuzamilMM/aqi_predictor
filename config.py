...
MONGO_URI = os.environ.get("MONGO_URI", "mongodb+srv://muzamilsthpg_db_user:S0XCnQg5lNVaLwkO@cluster0.gygdlvl.mongodb.net/?appName=Cluster0&tlsAllowInvalidCertificates=true")
